...
public class PerfilController {
    ...
    @FXML
    private Button onTicTacToeButton;
    ...
    /**
     * * Método que se ejecuta al hacer click en el botón de jugar al Tres en Raya
     * * @throws SQLException Excepción de SQL
     */
    @FXML
    protected void openTicTacToeClick() {
        try {
            Stage stage = (Stage) onVolverButton.getScene().getWindow();
            FXMLLoader fxmlLoader = new FXMLLoader(PrincipalApplication.class.getResource("tictactoe.fxml"));
            Scene scene = new Scene(fxmlLoader.load(), 450, 760);
